            ...
            <table id="presensiTable" class="w-full text-left border-collapse">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="py-6 text-gray-300 font-bold uppercase text-base tracking-wider border-b border-white/20 w-[25%] text-center">Catatan</th>
                    </tr>
                </thead>
                ...
                <tbody class="text-white text-sm">
                    ...
                    <tr class="group border-b border-white/5 transition-all duration-300 hover:bg-[#333] hover:scale-[1.01] cursor-pointer">
                        <td class="py-6 border-b border-white/10 font-medium pl-8">
                            <a href="{{ url('/progres/detail') }}" class="hover:text-[#0066FF] transition-colors relative z-20">
                                Nashwan Bima Andika
                            </a>
                        </td>
                        <td class="py-6 border-b border-white/10 text-center text-gray-300">Perancangan ERD</td>
                    ...
                    <tr class="group border-b border-white/5 transition-all duration-300 hover:bg-[#333] hover:scale-[1.01] cursor-pointer">
                        ...
                        <td class="py-6 border-b border-white/10 text-center text-gray-300">Pembuatan mockup website</td>
                        <td class="py-6 border-b border-white/10 text-center">
                            <button class="bg-[#0066FF] hover:bg-blue-600 text-white px-4 py-2 rounded-md text-xs flex items-center gap-1 mx-auto transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                Lihat File
                        ...
                        <td class="py-6 border-b border-white/10 text-center text-gray-300">Navbar terlalu lebar dan warna terlalu cerah</td>
                    </tr>

                    <tr class="group border-b border-white/5 transition-all duration-300 hover:bg-[#333] hover:scale-[1.01] cursor-pointer">
                        <td class="py-6 border-b border-white/10 font-medium pl-8 text-base">Itadori Yuji</td>
                        <td class="py-6 border-b border-white/10 text-center text-gray-300">Pembuatan database di PostgreSQL</td>
                        <td class="py-6 border-b border-white/10 text-center">
                            <button class="bg-[#0066FF] hover:bg-blue-600 text-white px-4 py-2 rounded-md text-xs flex items-center gap-1 mx-auto transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                Lihat File
